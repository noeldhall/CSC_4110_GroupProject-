...
public class PurchaseOrderGUI extends JPanel{
	...
	private JLabel needByLbl;
	private JButton addToOrderBtn;
	private JButton removeItemBtn;
	JScrollPane scrollPane;
	JComboBox<Item> itemBox;
	JList<OrderItem> orderItemList;
	DefaultComboBoxModel<Item> itemModel;
	DefaultListModel<OrderItem> orderModel;
	...
	public PurchaseOrderGUI(VendorProfile vp) {
		...
		needByLbl = new JLabel("Need By Date:");
		addToOrderBtn = new JButton("Add Item to Order");
		removeItemBtn = new JButton("Remove Selected Item");
		scrollPane = new JScrollPane();
		itemBox = new JComboBox<Item>();
		orderItemList = new JList<OrderItem>();
		itemModel = new DefaultComboBoxModel<Item>(ItemDataModel.searchVendorItemsByID(vp.getVendorID()));
	...
	public PurchaseOrderGUI(PurchaseOrder po) {
		this(po.getVendor());
		orderModel.addAll(po.getItemsVec());
		addToOrderBtn.setEnabled(false);
		removeItemBtn.setEnabled(false);
		needByTxt.setText(po.getNeedByDate().toGMTString());
		needByTxt.setEditable(false);
